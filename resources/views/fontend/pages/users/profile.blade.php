...
@section('sub_content')
  <div class='container'>
    <div class="card-body mb-5">
    	<h2 class="bg-secondary">This is Your Profile</h2>
      <form method="POST" action="">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-6">
            <input id="username" type="text" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ $user->user_name }}" required autofocus>
        ...
        <div class="form-group row">
          <label for="phone_num" class="col-md-4 col-form-label text-md-right">Phone No</label>

          <div class="col-md-6">
            <input id="phone_no" type="text" class="form-control{{ $errors->has('phone_no') ? ' is-invalid' : '' }}" name="phone_no" value="{{ $user->phone_number }}" required>
          ...
          <div class="col-md-6">
            <select class="form-control" name="district_id">
              ...
              @foreach ($districts as $district)
                <option value="{{ $district->id }}" {{ $user->districs_id == $district->id ? 'selected' : '' }}>{{ $district->name }}</option>
              @endforeach
            </select>
          </div>
        </div>
        ...
        <div class="form-group row">
          <label for="street_address" class="col-md-4 col-form-label text-md-right">Parmanent Address</label>

          <div class="col-md-6">
            <input id="street_address" type="text" class="form-control{{ $errors->has('street_address') ? ' is-invalid' : '' }}" name="street_address" value="{{ $user->parmanent_address }}" required>
